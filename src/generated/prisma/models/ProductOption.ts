...
export type ProductOptionCreateInput = {
  ...
  option: Prisma.OptionCreateNestedOneWithoutProductOptionsInput
}
...
export type ProductOptionUpdateInput = {
  ...
  option?: Prisma.OptionUpdateOneRequiredWithoutProductOptionsNestedInput
}
...
export type ProductOptionOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"productId" | "optionId", ExtArgs["result"]["productOption"]>
...
export interface ProductOptionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const productOptionWithProductIdOnly = await prisma.productOption.findMany({ select: { productId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many ProductOptions and only return the `productId`
   * const productOptionWithProductIdOnly = await prisma.productOption.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more ProductOptions and only return the `productId`
   * const productOptionWithProductIdOnly = await prisma.productOption.updateManyAndReturn({
   *   select: { productId: true },
   *   where: {
   *     // ... provide filter here
   *   },
